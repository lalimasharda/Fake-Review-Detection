...
/**
 * Servlet implementation class ReportDone
 */
@WebServlet("/ReportDone")
public class ReportDone extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = "Update userreporting set status='Fake' Where id='"+reportingid+"'";
